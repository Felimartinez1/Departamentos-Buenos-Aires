...
url_base = "https://www.remax.com.ar/listings/"
max_paginas = 65
links_lista = []
...
while x <= max_paginas:
    if x == pagina_actual:
        url = f"{url_base}rent?page={x}&pageSize=24&sort=-createdAt&in:operationId=2&in:eStageId=0,1,2,3,4&in:typeId=1,2,3,4,5,6,7,8&locations=in:CF@%3Cb%3ECapital%3C%2Fb%3E%20%3Cb%3EFederal%3C%2Fb%3E::::::&landingPath=&filterCount=1&viewMode=listViewMode"
        browser.get(url)
